                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      // Clear all button
                      if (_selectedLesson != null || _favouritesOnly)
                        TextButton.icon(
                          onPressed: () {
                            setState(() {
                    ...
                    children: [
                      _FilterChip(
                        ...
                        label: _selectedLesson == null
                            ? 'Lesson'
                            : furiganaOriginalText(
                                '$_selectedLesson. ${names[_selectedLesson! - 1]}',
                              ),
                        selected: _selectedLesson != null,
                        onTap: () => _showLessonPicker(),
                        onClear: _selectedLesson != null
                            ? () {
        ...
        content: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: FuriganaText('$lesson. ${names[index]}'),
